...
Netjsonconfig is part of the `OpenWISP project <http://openwrt.org>`_ and
...
Its main features are:
    ...
    - Plugin interface for external backends, support more firmwares with
      an external package

      - :doc:`Create your backend </backends/create_your_backend>` as a
        plugin
      - Experimental `AirOS support
        <https://github.com/edoput/netjsonconfig-airos>`_ as a plugin
    ...
    - **File inclusion**: easy inclusion of arbitrary files in
      configuration packages
    - **Variables**: reference variables in the configuration
    - **Command line utility**: easy to use from shell scripts or from
